...
public class Config extends PropertiesPersistent {
	...
	public Config(Application.ConfigToken t) {
		if(t == null)
			throw new RuntimeException(
					"Only Application can create a Config object");
		...
		try {
			...
			Application.printerr("Failed to create the configuration file");
		}
	}
	...
	private void initDefaults() {
		...
		if(serialPortId != null)
			serialPort = serialPortId.getName();
		else
			Application.printerr("Failed to create the serial port object");
		deviceId = 0;
